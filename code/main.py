...
if __name__ == "__main__":
    ...
    arg('--patience', type=int, default=100, help='Earlystop의 patience를 설정할 수 있습니다.')
    arg('--runname', type=str, default=None, help='모델과 파라티머의 정보를 간략하게 적어 내용을 저장할 수 있습니다.')
    ...
    arg('--optimizer', type=str, default='Adam', choices=['SGD', 'Adam', 'AdamW', 'NAdam', 'SparseAdam'], help='최적화 함수를 변경할 수 있습니다.')
    arg('--weight_decay', type=float, default=1e-6, help='Adam optimizer에서 정규화에 사용하는 값을 조정할 수 있습니다.')
    arg('--lr_scheduler', type=str, default=None, choices=['LAMBDA', 'Multiplicative', 'Step', 'MultiStep', 'Exponential', 'CosineAnnealing', 'Cyclic_triangular', 'Cyclic_triangular2',
                                                           'OneCycle_cos', 'OneCycle_linear', 'CosineAnnealingWarmRestarts'], help='Learning Rate Scheduler를 사용할 수 있습니다.')
